...
from nnunetv2.inference.predict_regression_from_raw_data import nnUNetRegressionPredictor
...
class nnUNetRegressionTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        # define loss here for now, may change later
        self.loss = "L2"
    ...
    # since we're doing a regression task, we use L1 or L2 loss
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        loss_here = np.mean(val_outputs['loss'])
    ...
    def on_epoch_end(self):
        ...
        if self._best_ema is None or self.logger.my_fantastic_logging['val_losses'][-1] < self._best_ema:
            ...
            self.print_to_log_file(f"Yayy! New minimum loss: {np.round(self._best_ema, decimals=4)}")
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        predictor = nnUNetRegressionPredictor(tile_step_size=0.5, use_gaussian=True, use_mirroring=True,
